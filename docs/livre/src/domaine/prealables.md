...
| Forme | Sens |
|---|---|
| `"GLG-1000"` | réussir ce cours (ou un équivalent) |
...
Dans un organigramme, un préalable doit être satisfait **avant** la session du cours — ou à la même session si `concomitant: true`.
